...
CoxNbr StandardSchubertContext::maximize(const CoxNbr &x, const LFlags &f) const
...
CoxNbr StandardSchubertContext::minimize(const CoxNbr &x, const LFlags &f) const
...
String &StandardSchubertContext::append(String &str, const CoxNbr &x) const
